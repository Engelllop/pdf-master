  ...
  return (
    <div className="fixed bottom-4 right-4 z-[100] flex flex-col gap-2 pointer-events-none">
      {toasts.map((toast) => {
        ...
        return (
          <div key={toast.id} className={`toast-pop pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-lg border shadow-lg text-sm text-white ${bg} min-w-[260px]`}>
