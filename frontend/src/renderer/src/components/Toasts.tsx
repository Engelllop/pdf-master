...
export default function Toasts() {
  ...
  // `grid` sin `gap`: el hueco de cada aviso se cierra solo al salir (`.toast-slot`)
  // y un `gap` del contenedor se quedaría abierto durante toda la salida.
  return (
    <div className="fixed bottom-4 right-4 z-toast grid justify-items-end pointer-events-none">
      {toasts.map((toast) => {
        ...
        return (
          <div key={toast.id} className="toast-slot" data-leaving={toast.leaving || undefined}>
